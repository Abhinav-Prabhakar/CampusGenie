          ...
          <section className="hero">
            ...
            <div className="who">
              ...
              <div className="hero-stats">
                <div className="stat">
                  <span className="stat-ic" style={{ "--t": "var(--orange)", color: "var(--orange)", background: "color-mix(in srgb, var(--orange) 16%, var(--surface))", borderColor: "color-mix(in srgb, var(--orange) 26%, var(--surface))" } as React.CSSProperties}>
                    <svg className="i i13" aria-hidden="true"><use href="#i-star"/></svg>
                  </span>
                  <div><b>3.81</b><span>GPA</span></div>
                </div>
                <div className="stat">
                  <span className="stat-ic" style={{ "--t": "var(--hue-meeting)", color: "var(--hue-meeting)", background: "color-mix(in srgb, var(--hue-meeting) 16%, var(--surface))", borderColor: "color-mix(in srgb, var(--hue-meeting) 26%, var(--surface))" } as React.CSSProperties}>
                    <svg className="i i13" aria-hidden="true"><use href="#i-cap"/></svg>
                  </span>
                  <div><b>112</b><span>Credits</span></div>
                </div>
                <div className="stat">
                  <span className="stat-ic" style={{ "--t": "var(--hue-hack)", color: "var(--hue-hack)", background: "color-mix(in srgb, var(--hue-hack) 16%, var(--surface))", borderColor: "color-mix(in srgb, var(--hue-hack) 26%, var(--surface))" } as React.CSSProperties}>
                    <svg className="i i13" aria-hidden="true"><use href="#i-cal"/></svg>
                  </span>
                  <div><b>18</b><span>Events this term</span></div>
                </div>
                <div className="stat">
                  <span className="stat-ic" style={{ "--t": "var(--green)", color: "var(--green)", background: "color-mix(in srgb, var(--green) 16%, var(--surface))", borderColor: "color-mix(in srgb, var(--green) 26%, var(--surface))" } as React.CSSProperties}>
