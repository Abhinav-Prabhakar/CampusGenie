export default function EventIcons() {
  return (
    ...
    >
      ...
      <symbol id="i-calplus" viewBox="0 0 24 24"><rect x="3" y="4.5" width="18" height="17" rx="2.5"/><path d="M8 2.5v4M16 2.5v4M3 10h18M12 13v5M9.5 15.5h5"/></symbol>
      ...
      <symbol id="i-share" viewBox="0 0 24 24"><circle cx="18" cy="5" r="2.6"/><circle cx="6" cy="12" r="2.6"/><circle cx="18" cy="19" r="2.6"/><path d="m8.4 10.8 7.2-4.2M8.4 13.2l7.2 4.2"/></symbol>
      <symbol id="i-gift" viewBox="0 0 24 24"><path d="M20 12v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-9M2 7h20v5H2zM12 22V7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7Z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7Z"/></symbol>
      <symbol id="i-trophy" viewBox="0 0 24 24"><circle cx="12" cy="8.5" r="5.5"/><path d="M8.3 13.3 7 22l5-3 5 3-1.3-8.7"/><path d="M12 3v-1"/></symbol>
      <symbol id="i-map" viewBox="0 0 24 24"><path d="M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4Z"/><path d="M8 2v16M16 6v16"/></symbol>
      <symbol id="i-tshirt" viewBox="0 0 24 24"><path d="M20.4 6 16 3.5a4.5 4.5 0 0 1-8 0L3.6 6 2 10.5l3 1.2V21h14v-9.3l3-1.2Z"/></symbol>
      <symbol id="i-coffee" viewBox="0 0 24 24"><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4Z"/><path d="M6 1v3M10 1v3M14 1v3"/></symbol>
      <symbol id="i-id" viewBox="0 0 24 24"><rect x="2" y="4.5" width="20" height="16" rx="2"/><circle cx="8.2" cy="11" r="2"/><path d="M5 16.8c.6-1.6 1.8-2.3 3.2-2.3s2.6.7 3.2 2.3M14.5 9.5h5M14.5 13h5M14.5 16.5h3"/></symbol>
      ...
      <symbol id="i-laptop" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="12.5" rx="1.5"/><path d="M2 20h20"/></symbol>
      <symbol id="i-mic" viewBox="0 0 24 24"><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10a7 7 0 0 0 14 0M12 19v3"/></symbol>
      ...
      <symbol id="i-lock" viewBox="0 0 24 24"><rect x="3.5" y="11" width="17" height="10.5" rx="2"/><path d="M7.5 11V7a4.5 4.5 0 0 1 9 0v4"/></symbol>
      <symbol id="i-nav" viewBox="0 0 24 24"><path d="m3 11 18.5-8.5L13 21l-2.2-7.8Z"/></symbol>
      <symbol id="i-info" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 11v5M12 7.5v.5"/></symbol>
      <symbol id="i-whatsapp" viewBox="0 0 24 24"><path fill="currentColor" stroke="none" d="M17.47 14.38c-.3-.15-1.76-.87-2.03-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.16-.17.2-.35.22-.64.08-.3-.15-1.26-.47-2.4-1.48-.88-.79-1.48-1.76-1.65-2.06-.17-.3-.02-.46.13-.6.13-.14.3-.35.44-.52.15-.18.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.01-1.04 2.48s1.06 2.87 1.21 3.07c.15.2 2.1 3.2 5.08 4.49.7.3 1.26.49 1.69.62.71.23 1.36.2 1.87.12.57-.09 1.76-.72 2-1.41.25-.7.25-1.29.18-1.42-.08-.12-.28-.2-.57-.35m-5.42 7.42a9.87 9.87 0 0 1-5.03-1.38l-.36-.22-3.75.99 1-3.65-.23-.38a9.86 9.86 0 0 1-1.52-5.26c0-5.45 4.44-9.88 9.89-9.88 2.64 0 5.12 1.03 6.99 2.9a9.83 9.83 0 0 1 2.89 6.99c0 5.45-4.43 9.89-9.88 9.89m8.41-18.31A11.82 11.82 0 0 0 12.05.02C5.5.02.16 5.36.16 11.91c0 2.1.54 4.14 1.58 5.95L.06 24l6.3-1.66a11.88 11.88 0 0 0 5.69 1.45c6.55 0 11.89-5.34 11.89-11.9 0-3.17-1.23-6.16-3.48-8.4"/></symbol>
    </svg>
  );
}
