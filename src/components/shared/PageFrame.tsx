...
/** Shared app-shell frame for feature pages: sidebar rail, slim header with
 *  shortcuts + theme controls, and a scrollable content column. Mirrors the
 *  admin page structure exactly. */
